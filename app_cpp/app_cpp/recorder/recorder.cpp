...
void recorder::add_data(portfolio d){
  portfolio_snapshots_.push_back(d);
}
void recorder::print_portfolio_snapshots(){
...
std::vector<portfolio> recorder::get_portfolio_snapshots(){
  return portfolio_snapshots_;
}
std::vector<portfolio> recorder::get_day_portfolio_snapshots(){
